# FLOWER_INSERT 一鍵訓練腳本
# 用法:  .\project\FLOWER_INSERT\run_train.ps1 [--num_envs 2048] [--max_iterations 1500] ...
#
...
& ".\isaaclab.bat" -p "project\FLOWER_INSERT\scripts\rsl_rl\train.py" `
    --task Isaac-Flower-Insert-Franka-Custom-v0 --headless `
    @args
