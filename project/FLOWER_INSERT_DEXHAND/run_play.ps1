# FLOWER_INSERT_DEXHAND 一鍵播放（載入訓練好的 checkpoint）腳本
# 用法:  .\project\FLOWER_INSERT_DEXHAND\run_play.ps1 [--num_envs 16] [--checkpoint <path>] ...
#
...
& ".\isaaclab.bat" -p "project\FLOWER_INSERT_DEXHAND\scripts\rsl_rl\play.py" `
    --task Isaac-Flower-Insert-KukaAllegro-Play-v0 --num_envs 16 `
    @args
